...
const SwipperBaner = () => {
  ...
  return (
    <section className='relative max-w-[1120px] w-full h-[536px]'>
      {swiperReady && (
        <Swiper
      ...
      <div className='w-full flex justify-between  pt-[32px] pb-[40px]'>
        <div className='font-poppins font-normal text-[72px] leading-[76px]  tracking-[-2px] text-[#141718]'>
          <p>
        ...
        <div className='max-w-[425px] w-full flex items-center  justify-start '>
          <p className='p-[29px] w-full font-poppins font-normal text-[16px] leading-[26px]   text-[#6C7275]'>
