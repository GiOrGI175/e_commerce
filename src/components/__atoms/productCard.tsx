    ...
    >
      <div className="relative w-[240px] ">
        <Image
          ...
          height={349}
        />
        <div className={`${layout === "Sort3" && "hidden"} absolute top-2 left-2`}>
      ...
      <div className={`text-[#121212] pt-[12px] ${layout === "Sort3" ? "gap-y-[16px]" : "gap-y-[4px]"} flex flex-col max-w-[282px] w-full`}>
